...
Name: torquebox-rubygem-uuidtools-21
Version: 2.1.1
Release: 1%{?dist}
...
Source0: http://rubygems.org/gems/uuidtools-2.1.1.gem
...
install -m 755 -d %{buildroot}%{gem_dir}/gems/uuidtools-2.1.1/lib
...
%defattr(-, root, root, -)
%{bin_dir}/
%{gem_dir}/gems/uuidtools-2.1.1/
%{gem_dir}/cache/uuidtools-2.1.1.gem
%{gem_dir}/specifications/uuidtools-2.1.1.gemspec
%doc %{gem_dir}/doc/uuidtools-2.1.1
